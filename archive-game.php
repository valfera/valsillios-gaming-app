...
<div class="page-banner">
	...
	<div class="page-banner__content container container--narrow">
		<h1 class="page-banner__title">On My Radar</h1>
		<div class="page-banner__intro">
            <p>Some interesting games to keep your eyes out for</p>
		</div>
	</div>
</div>
...
<div class="container container--narrow page-section">
    ...
    <p><a href="<?php echo site_url('/past-games') ?>">Recap Of This Years Releases</a></p>
</div>
